            ...
            <template class="section-wrapper" v-for="bookend in shelf[1]" :key="bookend" >
                <div class="section-title-box-wrapper">
                    ...
                    :class="{ 
                        ...
                        <h3 v-if="zoomLevel !== '0'" class="section-category">{{ categoryMap.get(allCollections[collectionName]['display'].viewType.bookend)[allCollections[collectionName]['display'].view.bookend] }}</h3>
                    ...
                    <div class="section-inner" 
                    v-for="item in bookend[1].slice(1, bookend[1].length)" 
                    :class="{ 
                            zoomOut : zoomLevel === '0',
                            zoomMid : zoomLevel === '50',
                            zoomIn : zoomLevel === '100',
