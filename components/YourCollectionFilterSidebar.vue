...
<div class="sidebar scrollable">
    <div class="sidebar-title-box">
        ...
        <h3>Total Items: {{ filterTotalCountYC }}</h3>
    </div>
                    ...
                    <template #popper >
                        ...
                        <div class="catalogue-filter-category-container scrollable form-style-1">
                            ...
                            <div class="unique-entries" >
                                <h4 >Unique entries: {{ Object.keys(searchList(filterObjectYC.get('Agent')[category], searchEntry)).length }}</h4>
                            </div> 
                            <button 
                            v-for="filterValue in searchList(filterObjectYC.get('Agent')[category], searchEntry)"
                ...
                <div class="chevron-box">
                    ...
                    <template #popper >
                        ...
                        <div class="catalogue-filter-category-container scrollable form-style-1">
                            ...
                            <div class="unique-entries" >
                                <h4 >Unique entries: {{ Object.keys(searchList(filterObjectYC.get('Book')[category], searchEntry)).length }}</h4>
                            </div> 
                            <button 
                            v-for="filterValue in searchList(filterObjectYC.get('Book')[category], searchEntry)"
                ...
                <div class="chevron-box">
                    ...
                    <template #popper >
                        ...
                        <div class="catalogue-filter-category-container scrollable form-style-1">
                            ...
                            <div class="unique-entries" >
                                <h4 >Unique entries: {{ Object.keys(searchList(filterObjectYC.get('Mark')[category], searchEntry)).length }}</h4>
                            </div> 
                            <button 
                            v-for="filterValue in searchList(filterObjectYC.get('Mark')[category], searchEntry)"
...
const { allCollections,
        ...
        filterObjectYC,
        getActiveFiltersYC,
        filterTotalCountYC } = storeToRefs(yourCollectionStore)
...
onMounted(()=>{
    activeFiltersYC.value = []
    watchEffect(()=>{
        yourCollectionStore.filterTotalCountYC
    })
})
